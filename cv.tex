...
\begin{longtable}{p{3cm}|p{12cm}}
  ...
  \multicolumn{2}{c}{} \\
  \textsc{Platforms} & GTK, Gstreamer, Rails, Android (and Android internals), Mono, Node.js, iOS, .net MVC, Xamarin's MonoDroid and MonoTouch, git, and the Linux kernel
\end{longtable}
...
\multicolumn{2}{c}{} \\
  ...
  \tiny{CREDIL} & \emph{Video Stream ``Reflector'' for IITB Webcasting System} \\
   & \footnotesize{Implemented ``{\href{https://github.com/orospakr/stream-pump}{Stream Pump}}'', a thin MMSH video stream reflector for enabling delivery of live video content to large numbers of desktops behind network bottlenecks in lieu of \mbox{layer 3} \mbox{multicast}.  Used Node.js and GNU/Linux.} \\
\multicolumn{2}{c}{} \\
